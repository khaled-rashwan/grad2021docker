...
namespace grad2021.Models
{
    public class Course
    {
        ...
        public double CourseWorkMaxScore { get; set; } = 10;

        [Display(Name = "النهاية العظمى لامتحان منتصف الفصل الدراسي")]
        public double MidTermExamMaxScore { get; set; } = 20;

        [Display(Name = "النهاية العظمى لامتحان الشفوي أو العملي")]
        public double OralExamMaxScore { get; set; } = 10;

        [Display(Name = "النهاية العظمى للامتحان التحريري")]
        public double TermExamMaxScore { get; set; } = 60;
